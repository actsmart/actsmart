 ...
 *
 * @todo - we probably want to bring the Slack Message structure here and webchat and facebook. The the conversation
 * controller can decide which method to use
 */
class Message
{
